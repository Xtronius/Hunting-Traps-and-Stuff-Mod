package mod.xtronius.htsm.item.inventory;

import mod.xtronius.htsm.util.INBTTaggable;
...
public class InventoryAmmoBag implements IInventory, INBTTaggable {
    public ItemStack parentItemStack;
    protected ItemStack[] inventory;
    protected String customName;

    public InventoryAmmoBag(ItemStack itemStack) {
    ...
    public boolean matchesUUID(UUID uuid) {
        return NBTHelper.hasUUID(parentItemStack) && parentItemStack.getTagCompound().getLong("UUIDLeastSig") == uuid.getLeastSignificantBits() && parentItemStack.getTagCompound().getLong("UUIDLeastSig") == uuid.getMostSignificantBits();
    }
    ...
    public String getInventoryName() {
        return this.hasCustomName() ? this.getCustomName() : "Ammo Bag";
    }
